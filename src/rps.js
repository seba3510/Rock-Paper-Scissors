...
/**
 * Represents the current score of the computer
 * @type {number}
 */
let compScore = 0;

/**
 * Represents the HTML element displaying the player's score.
 * @type {HTMLDivElement}
 */
const playerScoreWindow = document.querySelector("#playerScore");

/**
 * Represents the HTML element displaying the computer's score.
 * @type {HTMLDivElement}
 */
const compScoreWindow = document.querySelector("#computerScore");

// Setting initial scores in the respective score windows
playerScoreWindow.innerHTML = playerScore;
compScoreWindow.innerHTML = compScore;

/**
 * These variables store the scores of the player and the computer.
 * The playerScoreWindow and compScoreWindow variables store references to
 * the corresponding HTML elements displaying the scores.
 * The initial scores are set to 0 in the respective score windows.
 */
